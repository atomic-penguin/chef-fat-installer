...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/chef/rubies/ruby-1.9.2-p180")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/chef/rubies/ruby-1.9.2-p180' '--enable-shared' '--disable-install-doc'"
